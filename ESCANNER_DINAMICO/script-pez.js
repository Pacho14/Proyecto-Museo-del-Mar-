...
document.addEventListener('DOMContentLoaded', () => {
    console.log('🐟 Escáner Pez inicializando...');
    setupEventListeners();
    loadServerUrl();
});
...
async function uploadToServer() {
    ...
    try {
        ...
        formData.append('image', capturedImage, `pez_${Date.now()}.png`);
        ...
        updateServerStatus(`✅ ¡Captura enviada! PEZ`);
